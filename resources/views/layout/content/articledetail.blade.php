...
@section('content')
    <div class="container" style="margin-top: 50px; min-height: 100vh; padding: 0px 10%;" >
        ...
        <div class="w-100" style="height: 328px; background: url('{{ asset('storage/' . $article->ArticleImage->image) }}'); background-position: {{ $article->ArticleImage->x_offset * 2 }}px {{ $article->ArticleImage->y_offset * 2 }}px; background-size:{{ $article->ArticleImage->size }}%;" ></div>
