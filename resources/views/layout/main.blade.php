          ...
          <div class="collapse navbar-collapse " id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto ">
              <li class="nav-item navbar-active">
                <a class="nav-link font-xs hover-grow" href="/">Beranda</a>
              </li>
              <li class="nav-item">
                <a class="nav-link font-xs " href="/about">Tentang Kami</a>
              </li>
              <li class="nav-item">
                <a class="nav-link font-xs " href="/article">Artikel</a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link font-xs  dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Tempat
                </a>
